...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Menu version mobile - séparé du header */}
      <motion.div
        className="fixed inset-0 dark:bg-black/90 bg-white/90 backdrop-blur-lg flex md:hidden flex-col items-center justify-center z-45"
          ...
          {['accueil', 'projets', 'a propos', 'contact'].map((item, i) => {
            ...
            return (
              ...
              >
                <Link 
                  href={href}
                  className={`text-2xl font-medium relative block py-3 ${
                    isActive 
                      ? 'text-purple-500' 
